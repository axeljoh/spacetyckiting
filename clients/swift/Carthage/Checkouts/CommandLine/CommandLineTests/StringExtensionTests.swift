...
class StringExtensionTests: XCTestCase {
  ...
  func testPaddedByCharacter() {
    ...
    XCTAssertEqual(a.paddedToWidth(80).characters.count, 80, "Failed to pad to correct width")
    XCTAssertEqual(a.paddedToWidth(5).characters.count, a.characters.count, "Bad padding when pad width is less than string width")
    XCTAssertEqual(a.paddedToWidth(-2).characters.count, a.characters.count, "Bad padding with negative pad width")
